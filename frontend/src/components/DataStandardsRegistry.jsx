              ...
              >
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="font-medium">Governing Body:</span>
                    <span className="ml-1">{standard.governing_body}</span>
                  </div>
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="font-medium">Country:</span>
                    <span className="ml-1">{standard.country}</span>
                  </div>
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="font-medium">Version:</span>
                    <span className="ml-1">{standard.version}</span>
                  </div>
                  <div className="flex items-center text-xs text-gray-500">
                    <span className="font-medium">Required Fields:</span>
                    <span className="ml-1">{standard.required_fields?.length || 0}</span>
                  </div>
                </div>
              </div>
            ))}
