...
const FilePreview: React.FC<FilePreviewProps> = ({ analysis, getAllConfigs, tableName, setTableName, tableNameAvailable, setTableNameAvailable, showSQL, setShowSQL, generatedSQL, setGeneratedSQL }) => {
              ...
              <div className="mb-2">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full text-xs border border-gray-300 bg-white">
                    ...
                    <tbody>
                      {analysis.field_analysis.map((field: any, idx: number) => (
                        <tr key={idx}>
